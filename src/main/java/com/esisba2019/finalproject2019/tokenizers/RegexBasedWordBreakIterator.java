...
public class RegexBasedWordBreakIterator extends BreakIterator {
    ...
    /**
     * @see BreakIterator#following(int)
     */
    @Override
    ...
    /**
     * @see BreakIterator#setText(CharacterIterator)
     */
    @Override
